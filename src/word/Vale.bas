...
Sub updateClientText()
    ...
    ' Loop through all figures in the document
    Dim i As Long
    With doc
        For i = 1 To .InlineShapes.Count - 1
            With .InlineShapes(i)
                ...
                '.Height = .width / Aspect
                'Set rng = .Range
                rng.style = ActiveDocument.Styles("Figura VALE")
            End With
        Next i
    End With
    ...
    Dim cel As cell
    Dim j As Integer
    For j = 2 To doc.Tables.Count
        Set tbl = doc.Tables(j)
        For Each cel In tbl.Range.Cells
            Set rng = cel.Range
            ' Remove the end of cell marker from the range
            rng.End = rng.End - 1
            rng.style = "Tabela VALE" ' Replace with your desired style name
        Next cel
    Next j
End Sub
...
Sub addRevisionTable()
    ...
    With revisionTable
        ...
        For i = 5 To .Rows.Count
            insertCellText .cell(i, 3), "", "Tabela VALE"
        Next i
    End With
...
Sub addHeader()
    ...
    If ActiveDocument.Sections(1).Headers(wdHeaderFooterPrimary).Exists Then
        ...
        End With
    Else
        MsgBox "No primary header has been found in the document.", vbExclamation
    End If
...
Sub addFooter()
    ...
    If doc.Sections(1).Footers(wdHeaderFooterPrimary).Exists Then
        ...
        ' Access the footer of the first section (or use a loop for all sections)
        Dim footer As HeaderFooter
        Set footer = doc.Sections(1).Footers(wdHeaderFooterPrimary)
        
        ' Clear the existing footer content if necessary
        footer.Range.text = ""
        
        ' Add the desired text to the footer
        footer.Range.text = "Anexo A_PR-E-019_Rev_6" & vbCrLf & vbCrLf & vbCrLf
        
        footer.Range.style = "6ptLeft"
    Else
        MsgBox "No primary footer has been found in the document.", vbExclamation
    End If
End Sub
...
Sub setupStyles()
    ...
    ' FirstLineIndent (14)
    ' KeepWithNext (15)
    insertStyle "6ptLeft", "", "Arial", 6, False, False, wdUnderlineNone, RGB(0, 0, 0), False, wdAlignParagraphLeft, 0, 0, 0, Array(Array(0, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    ...
    insertStyle "12ptCenterBoldUnderline", "", "Arial", 12, True, False, wdUnderlineSingle, RGB(0, 0, 0), False, wdAlignParagraphCenter, 0, 0, 14, Array(Array(1.5, wdAlignTabLeft, wdTabLeaderSpaces), Array(17.5, wdAlignTabRight, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    ...
    insertStyle "Tabela VALE", "", "Arial", 12, False, False, wdUnderlineNone, RGB(0, 0, 0), False, wdAlignParagraphCenter, 0, 0, 0, Array(Array(0, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    insertStyle "Legenda VALE", "", "Arial", 10, True, False, wdUnderlineNone, RGB(0, 0, 0), False, wdAlignParagraphCenter, 0, 14, 0, Array(Array(0, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    insertStyle "Figura VALE", "", "Arial", 12, False, False, wdUnderlineNone, RGB(0, 0, 0), False, wdAlignParagraphCenter, 0, 0, 0, Array(Array(0, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    insertStyle "Título I_VALE_", "Heading 1", "Arial", 12, True, False, wdUnderlineNone, RGB(0, 0, 0), True, wdAlignParagraphJustify, 0, 28, 14, Array(Array(2, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0, True
    insertStyle "Título I.I_VALE_", "Heading 2", "Arial", 12, False, False, wdUnderlineNone, RGB(0, 0, 0), True, wdAlignParagraphJustify, 0, 14, 14, Array(Array(2, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0, True
    insertStyle "Título I.I.I_VALE_", "Heading 3", "Arial", 12, False, False, wdUnderlineSingle, RGB(0, 0, 0), False, wdAlignParagraphJustify, 0, 14, 14, Array(Array(2, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0, True
    insertStyle "Título I.I.I.I_VALE_", "Heading 4", "Arial", 12, False, False, wdUnderlineNone, RGB(0, 0, 0), False, wdAlignParagraphJustify, 0, 14, 14, Array(Array(2, wdAlignTabLeft, wdTabLeaderSpaces)), wdLineSpaceSingle, 0, True
    ...
    insertStyle "TOC 1", "", "Arial", 12, True, False, wdUnderlineNone, RGB(0, 0, 0), True, wdAlignParagraphJustify, 0, 0, 10, Array(Array(1.5, wdAlignTabLeft, wdTabLeaderSpaces), Array(17.5, wdAlignTabRight, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
    insertStyle "TOC 2", "", "Arial", 12, False, False, wdUnderlineNone, RGB(0, 0, 0), True, wdAlignParagraphJustify, 0, 0, 10, Array(Array(1.5, wdAlignTabLeft, wdTabLeaderSpaces), Array(17.5, wdAlignTabRight, wdTabLeaderSpaces)), wdLineSpaceSingle, 0
